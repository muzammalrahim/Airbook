...
class Create extends React.Component {
    ...
    constructor(props) {
        ...
        this.state = {
          validated: false,
          engine: {
            is_featured: this.props.data.extra_data.is_featured_aircraft
              ? this.props.data.extra_data.is_featured_aircraft
              : 0,
            user: this.props.data.extra_data.user
              ? this.props.data.extra_data.user.id
              : null,

            primary_contact: this.props.data.extra_data.user.contact.id,
          },
          selectedFile: null,
          category: [],
          manufacturer: [],
          ...
          selected_primary_contact: {
            ...
            label:
              props.data.extra_data.user.contact.first_name +
              " " +
              props.data.extra_data.user.contact.last_name,
            value: true,
          },
          ...
          selected_user: {
            value: this.props.data.extra_data.user
              ? this.props.data.extra_data.user.id
              : null,
          },
