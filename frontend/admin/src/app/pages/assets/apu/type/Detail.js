          ...
          <Grid container spacing={3}>
                <Grid item xs={12} md={9}>
                  ...
                  <Form.Group>
                    ...
                    <Form.Label style={this.txt_weight}>{types.name}</Form.Label>
                  </Form.Group>
                  <Form.Group>
                    <Form.Label>Manufacturer</Form.Label><br/>
                    <Form.Label style={this.txt_weight}>{selected_manufacturer}</Form.Label>
                  </Form.Group>
                  <Form.Group>
              ...
              <div className="kt-portlet__head-wrapper">
                <div className="kt-portlet__head-actions">
                  ...
                  <Link to={"/admin/"+this.state.type+"/type"} className="btn btn-clean btn-icon-sm">
                      ...
                      <Link to={"/admin/"+this.state.type+"/type/"+this.props.match.params.type_id+"/edit"} className="btn btn-primary">
