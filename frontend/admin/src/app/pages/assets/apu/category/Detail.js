          ...
          <Grid container spacing={3}>
                <Grid item xs={12} md={9}>
                  ...
                  <Form.Group>
                    ...
                    <Form.Label style={this.txt_weight}>{category.name}</Form.Label>
                  </Form.Group>
                  <Form.Group>
                    <Form.Label>Description</Form.Label><br/>
                    <Form.Label style={this.txt_weight}>{category.description}</Form.Label>
                  </Form.Group>
                  <Form.Group>
              ...
              <div className="kt-portlet__head-wrapper">
                <div className="kt-portlet__head-actions">
                  ...
                  <Link to={"/admin/"+this.state.type+"/category"} className="btn btn-clean btn-icon-sm">
                      ...
                      <Link to={"/admin/"+this.state.type+"/category/"+this.props.match.params.category_id+"/edit"} className="btn btn-primary">
