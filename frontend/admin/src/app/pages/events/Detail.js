                  ...
                  <div className="kt_section__detail">
                    <div className="row mb-4">
                        <div className="col-md-6 col-12">
                            ...
                            <div>{events.title ? events.title : '---'}</div>
                        </div>
                        <div className="col-md-6 col-12">
                    ...
                    <div className="row mb-4">
                        <div className="col-md-6 col-12">
                            ...
                            <div>{events.start_date ? events.start_date : '---'}</div>
                        </div>
                        <div className="col-md-6 col-12">
                            <div className="kt_detail__item_title">End Date</div>
                            <div>{events.end_date ? events.end_date : '---'}</div>
                        </div>
                    </div>
                    <div className="row mb-4">
                        <div className="col-md-6 col-12">
                    ...
                    <div className="row mb-4">
                        <div className="col-md-6 col-12">
                            ...
                            <div>{events.country ? events.country.name : '---'}</div>
                        </div>
                        <div className="col-md-6 col-12">
                            <div className="kt_detail__item_title">State</div>
                            <div>{events.state ? events.state.name : '---'}</div>
                        </div>
                    </div>
                    <div className="row mb-4">
                        <div className="col-md-6 col-12">
                            <div className="kt_detail__item_title">City</div>
                            <div>{events.city ? events.city.name : '---'}</div>
                        </div>
                        <div className="col-md-6 col-12">
                            <div className="kt_detail__item_title">Website</div>
                          <div>{events.website ? <a target="_blank" href={website}>{events.website}</a> : '---'}</div>
                        </div>
                    </div>
                    <div className="row mb-4">
                        <div className="col-md-6 col-12">
                            <div className="kt_detail__item_title">Location (Latitude and Longitude)</div>
                            <div>{events.location ? events.location : '---'}</div>
                        </div>
                        <div className="col-md-6 col-12">
