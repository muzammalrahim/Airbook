...
import {list, loadOptions, patch, MEDIA_URL, post} from "../../../crud/api";
...
class Edit extends React.Component {
    constructor(props) {
        ...
        const {model_id, type} = this.props.data.match.params
        this.state = {
            validated: false,
            model: {id: model_id},
            type: type,
    ...
    render() {
        const {initialOptions, modelsLoaded , validated, model, types, selectedType, selectedFile} = this.state;
        return (
            <Form
                noValidate
                ...
                <Form.Row>
                    ...
                    <Form.Group as={Col} md="6">
                        ...
                        <AsyncPaginate
                            ...
                            model="type"
                            value={selectedType.value ? selectedType :'select...'}
                            name="type"
                            isClearable = {true}
