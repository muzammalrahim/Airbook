...
class Detail extends React.Component {
  ...
  confirm() {
    if(this.state.action === 'status') {
      this.state.subscriber.is_active = this.state.is_active;
      patch('subscribers/'+this.state.subscriber.id+'/', this.state.subscriber).then(
        (response) => {
          delete response.data.type;
          this.setState({subscriber : response.data});
                  ...
                  <div className="kt_section__detail">
                    <div className="row mb-4">
                        ...
                        <div className="col-md-6 col-12">
                            ...
                            <div>{subscriber.email ? subscriber.email : '---'}</div>
                        </div>
                    </div>
                    <div className="row mb-4">
                        <div className="col-md-6 col-12">
                            <div className="kt_detail__item_title">Comments</div>
                            <div>{subscriber.comments ? subscriber.comments : '---'}</div>
                        </div>
                        <div className="col-md-6 col-12">
                    ...
                    <div className="row mb-4">
                        ...
                        <div className="col-md-6 col-12">
                            ...
                            <div>
                              <span onClick={(e) => this.handleModalShow(e,'status')} className={this.state.subscriber.is_active === 1 ? 'kt-switch kt-switch--sm kt-switch--success':'kt-switch kt-switch--sm kt-switch--danger'}>
                                <label>
                                  <input
                                    type="checkbox" checked={subscriber.is_active === 1 ? 'defaultChecked':''}
...
class DetailPage extends React.Component {
  constructor(props) {
    ...
    this.state = {errors:{}, showError:false, title: 'Subscriber'};
              ...
              <div className="kt-portlet__head-wrapper">
                <div className="kt-portlet__head-actions">
                  ...
                  <Link to={"/admin/subscriber"} className="btn btn-clean btn-icon-sm">
                      ...
                      <Link to={"/admin/subscriber/"+this.props.match.params.subscriber_id+"/edit"} className="btn btn-primary">
