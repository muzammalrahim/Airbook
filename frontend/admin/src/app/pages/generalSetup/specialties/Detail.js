...
class Detail extends React.Component {
  ...
  constructor(props) {
    super(props);
    const { speciality_id, type } = this.props.data.match.params
    const divStyle = {
      padding : '15px'
    };
  ...
  confirm() {
    if(this.state.action === 'status') {
      this.state.speciality.is_active = this.state.is_active;
      patch('speciality/'+this.state.speciality.id+'/', this.state.speciality).then(
        (response) => {
          delete response.data.type;
          this.setState({speciality : response.data});
                  ...
                  <div className="kt_section__detail">
                    <div className="row mb-4">
                        <div className="col-md-6 col-12">
                            ...
                            <div>{speciality.name ? speciality.name : '---'}</div>
                        </div>
                        <div className="col-md-6 col-12">
                    ...
                    <div className="row mb-4">
                        ...
                        <div className="col-md-6 col-12">
                            ...
                            <div>
                              <span onClick={(e) => this.handleModalShow(e,'status')} className={this.state.speciality.is_active === 1 ? 'kt-switch kt-switch--sm kt-switch--success':'kt-switch kt-switch--sm kt-switch--danger'}>
                                <label>
                                  <input
                                    type="checkbox" checked={speciality.is_active === 1 ? 'defaultChecked':''}
...
class DetailPage extends React.Component {
  constructor(props) {
    ...
    this.state = {errors:{}, showError:false, title: 'Speciality'};
              ...
              <div className="kt-portlet__head-wrapper">
                <div className="kt-portlet__head-actions">
                  ...
                  <Link to={"/admin/speciality"} className="btn btn-clean btn-icon-sm">
                      ...
                      <Link to={"/admin/speciality/"+this.props.match.params.speciality_id+"/edit"} className="btn btn-primary">
