...
class Create extends React.Component {
  ...
  handleSubmit(event) {
    ...
    if(this.handleValidation()) {
      ...
      post('continent', this.state.continent).then(
          (response) => {
            this.setState({continent: response.data});
            this.state.action == 'save_new' ? this.clearForm("continent-form") : this.props.data.history.push("/admin/continent");
          }).catch(error => {
  ...
  clearForm = (id) => {
    this.props.data.history.replace("/admin/continent");
    this.props.data.history.replace("/admin/continent/create");
  }
  render() {
