...
class Create extends React.Component {
  ...
  handleSubmit(event) {
    ...
    if(this.handleValidation()) {
      ...
      post("departments", this.state.title)
        .then((response) => {
          this.setState({ title: response.data });
          this.state.action == "save_new"
            ? this.clearForm("job-title-form")
  ...
  clearForm = (id) => {
      this.props.data.history.replace("/admin/departments");
      this.props.data.history.replace("/admin/departments/create");
  }
  render() {
    ...
    return (
      ...
      >
        ...
        <Button
          type="submit"
          onClick={(e) => this.setState({ action: "save" })}
        ...
        <Button
          type="submit"
          onClick={(e) => this.setState({ action: "save_new" })}
