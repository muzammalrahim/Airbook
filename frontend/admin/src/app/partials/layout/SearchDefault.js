...
const fakeData = [
  ...
  },
  {
    ...
    iconImage: toAbsoluteUrl("/static/media/users/user1.jpg")
  },
  {
    type: 1,
    text: "Kennedy Lloyd",
    iconImage: toAbsoluteUrl("/static/media/users/user2.jpg")
  },
  {
    type: 1,
    text: "Megan Weldon",
    iconImage: toAbsoluteUrl("/static/media/users/user3.jpg")
  },
  {
    type: 1,
    text: "Marc-André ter Stegen",
    iconImage: toAbsoluteUrl("/static/media/users/user4.jpg")
  },
  {
    type: 0,
    text: "Files"
