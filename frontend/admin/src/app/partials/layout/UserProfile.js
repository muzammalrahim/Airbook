      ...
      <Dropdown className="kt-header__topbar-item kt-header__topbar-item--user" drop="down" alignRight>
        ...
        >
          ...
          <div className="kt-header__topbar-user">
            ...
            {showAvatar && <img alt="Pic" src={user.pic ? user.pic : `${toAbsoluteUrl("/static/media/users/default.jpg")}`} />}
        ...
        <Dropdown.Menu className="dropdown-menu-fit dropdown-menu-right dropdown-menu-anim dropdown-menu-top-unround dropdown-menu-xl">
          ...
          <div
            ...
            style={{
              backgroundImage: `url(${toAbsoluteUrl("/static/media/misc/bg-1.jpg")})`
            }}
          >
            ...
            <div className="kt-user-card__name" style={{fontSize:'14px'}}>
              {user.email}
            </div>
          </div>
          <div className="kt-notification">
            <Link to={"/admin/account-setting"} className="kt-notification__item">
