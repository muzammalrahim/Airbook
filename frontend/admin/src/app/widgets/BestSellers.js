              ...
              <div className="kt-widget5__content">
                <div className="kt-widget5__pic">
                  <img
                    ...
                    src={toAbsoluteUrl("/static/media/products/product6.jpg")}
                  />
                </div>
              ...
              <div className="kt-widget5__content">
                <div className="kt-widget5__pic">
                  <img
                    alt=""
                    className="kt-widget7__img"
                    src={toAbsoluteUrl("/static/media/products/product11.jpg")}
                  />
                </div>
                <div className="kt-widget5__section">
              ...
              <div className="kt-widget5__content">
                <div className="kt-widget5__pic">
                  <img
                    alt=""
                    className="kt-widget7__img"
                    src={toAbsoluteUrl("/static/media/products/product10.jpg")}
                  />
                </div>
                <div className="kt-widget5__section">
