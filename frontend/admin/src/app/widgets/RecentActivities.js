              ...
              <div className="kt-timeline-v2__items kt-padding-top-25 kt-padding-bottom-30">
                ...
                <div className="kt-timeline-v2__item">
                  ...
                  <div className="kt-list-pics kt-list-pics--sm kt-padding-l-20">
                    <a>
                      <img
                        src={toAbsoluteUrl("/static/media/users/100_4.jpg")}
                        title=""
                        alt=""
                      />
                    </a>
                    <a>
                      <img
                        src={toAbsoluteUrl("/static/media/users/100_13.jpg")}
                        title=""
                        alt=""
                      />
                    </a>
                    <a>
                      <img
                        src={toAbsoluteUrl("/static/media/users/100_11.jpg")}
                        title=""
                        alt=""
                      />
                    </a>
                    <a>
                      <img
                        src={toAbsoluteUrl("/static/media/users/100_14.jpg")}
                        title=""
                        alt=""
                      />
                    </a>
